...
\and
\IEEEauthorblockN{3\textsuperscript{rd} Joseph Giordano}
\IEEEauthorblockA{\textit{dept. name of organization (of Aff.)} \\
\textit{name of organization (of Aff.)}\\
City, Country \\
email address or ORCID}
\and
\IEEEauthorblockN{4\textsuperscript{th} Dylan Skelly}
\IEEEauthorblockA{\textit{dept. name of organization (of Aff.)} \\
\textit{name of organization (of Aff.)}\\
City, Country \\
email address or ORCID}
...
Benefits and what the speed up is
...
Dylan (arjun was being stubborn, that's why)

\section{Team Management and Organization}
Arjun
