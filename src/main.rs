...
//     let path = String::from("./medium_sized_file.txt");
//     let content = "The fox jumped over the fence.".as_bytes();

//     aws::write_to_bucket(&path, content.to_vec());

//     let bruh = aws::read_from_bucket(&path);
